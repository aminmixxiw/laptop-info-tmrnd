        ...
        <header id="header" class="header-scroll top-header headrom">
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/iLokal.png" alt=""> </a>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="payment-option">
                                        <ul class=" list-unstyled">
                                            ...
                                            <li>
                                                <label class="custom-control custom-radio  m-b-20">
                                                    <input name="mod" id="radioStacked1" checked value="onlinebanking" type="radio" class="custom-control-input"> <span class="custom-control-indicator"></span> <span class="custom-control-description">Online Banking</span>
                                                </label>
                                            </li>
                                            <!--
                                            <li>
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Address</h5>
                                    <p>UiTM Kuala Terengganu, Chendering, Kuala Terengganu</p>
                                    <h5>Phone: +603341609</a></h5> </div>
