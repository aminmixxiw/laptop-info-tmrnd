...
if(isset($_POST['submit']))          
{
		...
		if(empty($_POST['d_name'])||empty($_POST['about'])||$_POST['res_name']=='')
		{	
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-archive f-s-20 color-warning"></i><span class="hide-menu">Laptop</span></a>
                            <ul aria-expanded="false" class="collapse">
								<li><a href="all_restaurant.php">All Laptop</a></li>
								<li><a href="add_category.php">Add Category</a></li>
                                <li><a href="add_restaurant.php">Add Laptop</a></li>
                                
                            </ul>
                        </li>
                      <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-cutlery" aria-hidden="true"></i><span class="hide-menu">More</span></a>
                            <ul aria-expanded="false" class="collapse">
									  ...
									  <hr>
                                        ...
                                        <div class="rowp-t-20">
                                            <div class="col-md-6 ">
                                                <div class="form-group">
                                                    <div class="form-group">
                                                    <label class="control-label">Description (Processor/RAM/Storage/ ETC)</label>
                                                    <textarea name="about" type="text" style="height:100px; width: 890px" class="form-control"></textarea>
                                                </div>
                                            </div>
                                        </div>
