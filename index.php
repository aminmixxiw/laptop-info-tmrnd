...
<body class="home">
        ...
        <section class="hero bg-image" data-image-src="images/Capture.jpg">
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
					...
					<p> IT UNIT TMRND CYBERJAYA <p>
                    <p class="lead"></p>
                </div>
                <div class="row">
						<?php 					
						$query_res= mysqli_query($db,"SELECT * FROM `dishes` ORDER BY `d_id` DESC LIMIT 6 "); 
                                    ...
                                    echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                            <div class="food-item-wrap">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <div class=echo $latest_message;"product-name">'.$r['slogan'].'</div>
